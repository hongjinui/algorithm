...
//            userMap.put(user,0);
//            badUserMap.put(user, new HashSet<>());
//        }
//
...
//// //                singoCntMap.put(badUser,1);
////                 badUserMap.put(badUser, new HashSet<>());
////                 badUserMap.get(badUser).add(user);
////             }else{
//// //                singoCntMap.put(badUser, singoCntMap.get(badUser)+1);
////                 badUserMap.get(badUser).add(user);
////             }
////         }
//
...
//        // }
//
//        for(String badUser : badUserMap.keySet()){
//            Set<String> userList = badUserMap.get(badUser);
//            if(userList.size() >= 2){
...
//        }
//
////        for( Map.Entry<String,Integer> entry : singoCntMap.entrySet() ){
////            if(entry.getValue() >= 2){
////                Set<String> set = badUserMap.get(entry.getKey());
////
////                for( String user : set ){
////                    userMap.put(user, userMap.get(user)+1);
////                }
